...
buttons = [
   ...
   [
    ...
    [
        InlineKeyboardButton(text="ABOUT", callback_data="Jarvis_"),
        InlineKeyboardButton(text="SUPPORT", url=f"https://t.me/Flex_Support_Chat"),
    ],
   [
        InlineKeyboardButton(text="ANIME INFO", url=f"https://t.me/Anime_Information_Hindi"),
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_sticker(
                "CAACAgUAAxkBAAEMZBlmfvCLnI-fRkji3CAj68Tmnz_fiAACCg4AAtN--VfQtz1zlj5hjjUE"
            )
        ...
        query.message.edit_caption("๏ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ᴛᴏ ɢᴇᴛ ʜᴇʟᴩ ᴀɴᴅ ᴍᴏʀᴇ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀ"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="COMMUNITY", url=f"https://t.me/EMXES_COMMUNITY"
                        ),
                        InlineKeyboardButton(
                            text="UPDATES", url=f"https://t.me/FleX_Bots_News"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text="ANIME HINDI", url=f"https://t.me/Anime_Barlow"
                        ),
                        InlineKeyboardButton(
                            text="NETWORK", url=f"https://t.me/EMXES_NETWORK",
                        ),
                    ],
                    [
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
             [
                 InlineKeyboardButton(text="UPDATES", url=f"https//t.me/FleX_Bots_News")
             ],
